    ...
    <div className="min-h-screen bg-gradient-to-b from-[#020806] via-[#0a2818] to-[#0d3320] px-4 sm:px-8 py-10">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-4">
          {announcements.map((a) => (
            <div key={a._id} className="rounded-xl bg-[#0d2818] p-4 flex items-center justify-between gap-4">
              <div>
              ...
              <div className="flex gap-3 shrink-0">
                <Link href={`/admin/announcements/${a._id}/edit`} className="text-green-300 text-sm hover:text-white">
                  Edit
                </Link>
                <button onClick={() => handleDelete(a._id)} className="text-red-400 text-sm hover:text-red-300">
                  Delete
                </button>
              </div>
            </div>
